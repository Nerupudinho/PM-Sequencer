...
- **Your Supabase connection string**: 
  - Go to Supabase Dashboard → Your Project (`npktknoqdivjlwpgjvtb`) → Settings → Database
  - **IMPORTANT**: Use **Connection Pooling** URL (port 6543), NOT direct connection (port 5432)
  - Format: `postgresql://postgres:[your-password]@[pooler-host].supabase.co:6543/postgres`
...
|--------------|-------|--------------|
| `DATABASE_URL` | Supabase pooler URL (port 6543) | Supabase Dashboard → Project `npktknoqdivjlwpgjvtb` → Settings → Database → Connection Pooling |
...
1. Go to Supabase Dashboard → Project `npktknoqdivjlwpgjvtb`
2. Settings → Database → Connection Pooling
3. **Copy the pooler connection string** (look for port **6543**, NOT 5432)
   - Format: `postgresql://postgres:[your-password]@[pooler-host].supabase.co:6543/postgres`
   - If you don't see Connection Pooling, enable it first
4. **Use this pooler URL** in Netlify `DATABASE_URL` variable
