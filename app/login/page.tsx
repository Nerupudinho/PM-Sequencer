      ...
      <div className="max-w-md w-full px-6 py-12">
        <div className="text-center mb-8">
          ...
          <p className="text-slate-600">
            For mid–senior PMs (3–10 yrs). No browsing. No decision fatigue. Just watch, learn, and apply it Monday morning.
          </p>
        </div>
        ...
        <div className="bg-white rounded-2xl shadow-xl p-8 border border-slate-200">
          <button
            ...
            className="w-full flex items-center justify-center gap-3 px-6 py-3 bg-white border-2 border-slate-300 rounded-lg font-medium text-slate-900 hover:bg-slate-50 hover:border-slate-400 transition-colors"
          >
            <svg
              className="w-5 h-5"
              viewBox="0 0 24 24"
